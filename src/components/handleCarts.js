        ...
        if (productElement) {
            ...
            if (parseInt(quantityElement, 10) === 0) {
                ...
                if (currentQuantity <= 0) {
                    ...
                    cantProductElement.textContent = `${currentQuantity} x`;
                ...
                cantProductElement.textContent = `${quantityElement} x`;
                ...
                butonConfirm.addEventListener("click", () => {
                   ...
                   array.forEach((product, index) => {
                    ...
                    containerConfirmContainerDatos.innerHTML = `
                        ...
                        <div class="container-confirm__datos">
                            <div>
                                <h3>${product.name}</h3>
                                <div>
                                    <span class="cant">${product.textContent}x</span>
                                    <span class="product-price">@ $${product.price.toFixed(2)}</span>
                                </div>
                            </div>
                            <span class="total-price">$${(quantityElement * product.price).toFixed(2)}</span>
                        </div>
                    `;
            
                    containerConfirm.appendChild(containerConfirmContainerDatos);
                   })
