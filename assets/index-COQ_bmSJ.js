(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const i of t.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function c(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function r(e){if(e.ep)return;e.ep=!0;const t=c(e);fetch(e.href,t)}})();function w(){const o=document.querySelectorAll(".total-price"),n=document.querySelector(".section-cart__title"),c=document.querySelector(".section-cart__container-empty"),r=document.querySelector(".section-cart__container-items");let e=0;o.forEach(s=>{e+=parseFloat(s.textContent)});const t=document.querySelector(".pTotal");if(t==null){n.textContent="Your Cart (0)";return}t.textContent=`$${e.toFixed(2)}`;const i=Array.from(document.querySelectorAll(".section-cart__product .cant")).reduce((s,C)=>s+parseInt(C.textContent,10),0);n.textContent=`Your Cart (${i})`,i===0?(c.style.display="block",r.style.display="none"):(c.style.display="none",r.style.display="block")}let d=[];const x=(o,n,c,r)=>{if(!c||!c.id){console.error("buttonAdded no es válido o no tiene un 'id'");return}const e=document.querySelector(".section-cart__container-empty"),t=document.querySelector(".section-cart__container-items");e.style.display="none";const i=c.id,s=o[i];if(!s){console.error("Producto no encontrado");return}if(d.find(a=>a.name===s.name)){const a=document.querySelector(`.section-cart__product[data-id="${s.name}"]`);if(a){const l=a.querySelector(".cant"),p=a.querySelector(".total-price");let u=parseInt(l.textContent,10);parseInt(n,10)===0?(u-=1,u<=0?(d=d.filter(f=>f.name!==s.name),a.remove()):(l.textContent=`${u} `,p.textContent=(u*parseFloat(s.price)).toFixed(2))):(l.textContent=`${n} `,p.textContent=(parseInt(n,10)*parseFloat(s.price)).toFixed(2))}}else{d.push({...s,quantity:parseInt(n,10)});const a=document.createElement("DIV");a.classList.add("section-cart__product"),a.setAttribute("data-id",s.name),a.innerHTML=`
        ...
        `,t.appendChild(a),a.querySelector(".icono-remove").addEventListener("click",()=>{const p=d.findIndex(v=>v.name===s.name);p!==-1&&(d[p].quantity=1),d=d.filter(v=>v.name!==s.name),a.remove();const u=document.querySelector(`.add-to-cart[id="${c.id}"]`),f=document.querySelector(`.added[id="${c.id}"]`);u&&f&&(u.style.display="flex",f.style.display="none",r.style.border="none"),w()})}let m=document.querySelector(".container-total");if(!m){m=document.createElement("DIV"),m.classList.add("container-total"),m.innerHTML=`
                            ...
                            <div class="container-confirm__container-datos">
                                <div class="container-datos__datos">
                                    ...
                                    <div class="container-datos__cantyprice">
                                        <span class="cant">${f[_].textContent}x</span>
                                        <span class="product-price">@ $${y.price.toFixed(2)}</span>
                                    </div>
                                </div>
                                <span class="total-price">$${(parseInt(f[_].textContent)*y.price).toFixed(2)}</span>
                            </div>
                        `,u.appendChild(h)}),p.querySelector(".container-confirm__button").addEventListener("click",()=>{d=[];const y=document.querySelector(".section-cart__container-items");y.innerHTML="";const _=document.querySelector(".section-cart__container-empty");_.style.display="block",a.remove();const h=document.querySelectorAll(".add-to-cart"),S=document.querySelectorAll(".added");h.forEach(g=>g.style.display="flex"),S.forEach(g=>g.style.display="none"),w(),q(o)})})}t.appendChild(m),w()},L=(o,n,c,r)=>{const e=o.querySelector(".increment"),t=o.querySelector(".decrement"),i=o.querySelector(".quantity");i.textContent=1,x(c,i.textContent,o,r),e.replaceWith(e.cloneNode(!0)),t.replaceWith(t.cloneNode(!0));const s=o.querySelector(".increment"),C=o.querySelector(".decrement");function m(){let l=parseInt(i.textContent,10);i.textContent=l+1,x(c,i.textContent,o,r)}function a(){let l=parseInt(i.textContent,10);l>1?(i.textContent=l-1,x(c,i.textContent,o,r)):l===1&&(o.style.display="none",n.style.display="flex",i.textContent="1",r.style.border="none",x(c,0,o,r))}s.addEventListener("click",m),C.addEventListener("click",a)},q=o=>{const n=document.querySelectorAll(".add-to-cart"),c=document.querySelectorAll(".added"),r=document.querySelectorAll(".product-img");n.forEach(e=>{e.addEventListener("click",()=>{e.style.display="none",c.forEach(t=>{e.id==t.id&&(t.style.display="flex",r[t.id].style.border="1px solid hsl(14, 86%, 42%)",r[t.id],L(t,e,o,r[t.id]))})})})},$=document.querySelector(".container-productos"),E=async()=>{try{const n=await(await fetch("data.json")).json();M(n)}catch(o){console.error("error al cargar los productos",o)}},M=o=>{o.forEach((n,c)=>{const r=document.createElement("div");r.classList.add("product"),r.innerHTML=`
